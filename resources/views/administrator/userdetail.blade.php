    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-5">
                    <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> <strong>Email Address:</strong> {{$user->email}} @if($user->emailVerified())
                    <span class="label label-success">CONFIRMED</span> @else
                    <span class="label label-danger">NOT CONFIRMED</span> @endif
                </div>
                <br>
                <br>
                <div class="col-md-6">
